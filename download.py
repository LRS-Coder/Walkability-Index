...
def download_all(location, boundary, folder="data"):
    ...
    # return subfolder for main pipeline to use
    return subfolder
...
def download_confirm():
    ...
    while True:
        ...
        while True:
            ...
            # if satisfied by boundary download the data within it
            if satisfactory in ['y','yes']:
                print('User is satisfied with the boundary.')
                subfolder = download_all(location, download_boundary)
            ...
            # if not satisfied by boundary loop back to start
            elif satisfactory in ['n','no']:
                print('User is NOT satisfied with the boundary.')
                break

            # if any other input then loop to satisfied question
            else:
